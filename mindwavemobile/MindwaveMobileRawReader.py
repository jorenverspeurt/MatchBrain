...
# Forked from github.com/robintibor/python-mindwave-mobile
...
class MindwaveMobileRawReader:
    ...
    def connectToMindWaveMobile(self, mindwaveMobileAddress= '20:68:9D:79:DA:78'):
    ...
    def peekByte(self):
        self._ensureMoreBytesCanBeRead(1)
